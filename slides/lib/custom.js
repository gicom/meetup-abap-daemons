...
/* Source: https://github.com/cassioiks/highlight.js/blob/master/src/languages/abap.js */
  ...
  return {
    ...
    k: {
      keyword:
        ...
        " BOUND MESSAGING CHANNELS SECONDS CLASS ENDCLASS METHOD ENDMETHOD|10 DO FORM IF LOOP MODULE START-OF_FILE DEFINE WHILE BEGIN ENDDO ENDFORM|10 ENDIF ENDLOOP ENDMODULE END-OF_FILE END-OF-DEFINITION ENDWHILE END CHAIN ENDCHAIN CASE ENDCASE FUNCTION ENDFUNCTION ELSEIF ELSE TRY ENDTRY|10 CATCH CAST FIELD-SYMBOL",
...
function waitForHljs() {
  if (typeof hljs !== "undefined") {
    ...
    window.setTimeout(waitForHljs, 100);
  }
}
